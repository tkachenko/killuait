...
var poddannya = [
    ...
    'З IP офісу виконано МС дДОС атаку на сайт президента (3 одночасні запити).',
    ...
    'Правительство Польши, Болгарии, Нидерландов и Литвы попросили помочь с развитием их ИТ рынка, помогаем!',
    'Згідно постанови ВЛКСМ від 04.13.1931 - "Про розкулачення", за підписом Н. Хрущева.',
...
function getRandomRandomRandom(){
    ...
    $('#msg').html('<b>Обшук, розбиті двері, арешт обладнання, випиття кави та "загублені" 2 iPhone на підставі:</b>' +
        ' <br><br>'+ getRandomMsg());
